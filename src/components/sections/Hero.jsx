          ...
          <div className="text-left">
            ...
            <Fadein delay={100}>
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-normal text-white mb-6 leading-tight">
                Full-stack and iOS software engineer
              </h1>
            </Fadein>

            <Fadein delay={200}>
              <p className="text-lg text-white/70 max-w-[550px] mb-8 ">
                Bulding scalable and efficient web and mobile applications with
                a focus on
              </p>
            </Fadein>
            ...
            <div className="relative">
              <div className="relative overflow-hidden rounded-2xl aspect-4/5 max-w-[500px] ml-auto group">
                ...
                <div className="absolute bottom-6 left-6 z-20">
                  <Fadein delay={500}>
                    <div className="flex items-center gap-4 bg-black/40 backdrop-blur-sm border border-white/10 px-6 py-3 rounded-full">
